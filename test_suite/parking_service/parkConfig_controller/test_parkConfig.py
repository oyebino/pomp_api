...
from Api.parking_service.createParking_service import CreateParking, Operation_parking
from conftest import aompLogin
...
test_data, case_desc = YmlUtils("/test_data/parking_service/parkConfig_controller/createParking.yml").getData
