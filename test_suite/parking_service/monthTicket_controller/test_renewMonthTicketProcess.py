...
test_data,case_desc = YmlUtils("/test_data/parking_service/monthTicket_controller/renewMonthTicketProcess.yml").getData
...
class TestRenewMmonthTicketProcess():
    ...
    def test_renew_vip(self,userLogin,send_data,expect):
        re = monthTicket_controller(userLogin).renew_two_monthTicket(send_data["carNum"], send_data["ticketName"])
        result = re.json()
