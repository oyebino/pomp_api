...
test_data,case_desc = YmlUtils("/test_data/carInOut_service/adjustCarNum.yml").getData
...
class TestAdjustCarNum(BaseCase):
    ...
    def test_adjustCarInNum(self,sentryLogin,send_data,expect):
        """校正进场车辆"""
        re = CheckInOut(sentryLogin).adjust_carNum_carType(send_data['parkUUID'],send_data['adjustCarNum'])
