...
from Api.sentry_service.carInOut_service.recordInOut_service import RecordInOut
...
test_data,case_desc = YmlUtils("/test_data/sentry_service/carInOut_service/recordInOut.yml").getData
