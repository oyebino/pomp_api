...
test_data,case_desc = YmlUtils("/test_data/parkingConfig/vemsParking/businessCoupon/timeCouponCover.yml").getData
@pytest.mark.parametrize(args_item, test_data)
@allure.feature("线下车场-优惠劵模块")
@allure.story('vems可叠加的时间券创建并使用')
class TestTimeCouponCover(BaseCase):
    """可叠加时间劵创建并使用"""
